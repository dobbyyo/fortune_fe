      ...
      {savedTarotCardsData &&
        savedTarotCardsData.savedTarotCardsResults.map((card) => (
          <div key={card.id} className="flex flex-col items-center w-full">
            <h3 className="mb-4 text-[16px] sm:text-[20px] font-medium text-center">[{card.subTitle}]</h3>
            ...
            <p className="mt-4 text-[16px] sm:text-[20px] font-medium  text-center">{card.cardName}</p>
            ...
            <div className="flex flex-col justify-center items-center w-full">
              <div className="mt-4 text-start flex flex-col items-start w-full">
                <div className="bg-[#D9D9D9] w-full float-start justify-center items-center  mb-[16px] py-2 pl-2">
                  <h4 className="text-[16px] sm:text-[20px] font-bold">🔥 카드 해석</h4>
                </div>
                <p className="text-[14px] sm:text-[18px] font-normal indent-2 mb-[30px]">{card.cardInterpretation}</p>
              </div>
            </div>
          </div>
        ))}
